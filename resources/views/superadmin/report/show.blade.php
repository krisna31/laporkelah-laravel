    ...
    <div class="py-12">
                        ...
                        <h1
                            ...
                            @can('update', $report)
                                <a href="{{ route('report.edit', $report) }}"
                                    class="text-orange-500 hover:text-orange-700"><svg class="w-10 h-10 inline"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div
                        class="relative overflow-x-auto sm:rounded-lg flex justify-center items-center flex-col gap-4">
                                    ...
                                    <div class="flex flex-row">{{ $comment->user->name }} |
                                        ...
                                        @can('update', $report)
                                            ...
                                            <a href="{{ route('comment.edit', $comment) }}"
                                                class="text-orange-500 hover:text-orange-700"><svg class="w-5 h-5 inline"
                                            ...
                                            <form action="{{ route('comment.destroy', $comment) }}" method="POST">
                                                <button type="submit" class="text-red-500 hover:text-red-700"
                                                    onclick="return confirm('Are you sure?')"><svg class="w-5 h-5 inline"
                                                        fill="none" stroke="currentColor" stroke-width="1.5"
                                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                        aria-hidden="true">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
