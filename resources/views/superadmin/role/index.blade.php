                                ...
                                @forelse ($roles as $role)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 flex gap-3">
                                            <a href="{{ route('role.show', $role) }}" type="button"
                                            ...
                                            <a href="{{ route('role.edit', $role) }}" type="button"
                                            ...
                                            <button type="button" data-modal-target="popup-modal-{{ $role->id }}"
                                                data-modal-toggle="popup-modal-{{ $role->id }}"
                                                ...
                                                <div class="relative w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="p-6 text-center">
                                                            ...
                                                            <button data-modal-hide="popup-modal-{{ $role->id }}"
                                                                type="button"
